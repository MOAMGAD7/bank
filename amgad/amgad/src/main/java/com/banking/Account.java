...
public class Account {
    ...
    public void initialize() {
        ...
        // Initialize the bar chart with percentages
        initializeBarChart();

        // Get the last 6 transactions from all sources
        ...
        for (int i = 0; i < transactions.size(); i += 2) {
            ...
            // Second transaction in the pair (if exists)
    ...
    private HBox createTransactionCard(com.banking.TransferConfirm.Transaction t) {
        ...
        String imgPath = isIncoming ? "/s1.png" : "/s2.png";
    ...
    private void initializeBarChart() {
        ...
        // Calculate maximum value for percentage calculation
        double maxValue = 0;
        for (int i = 0; i < 6; i++) {
            ...
            // Get income including card amounts
        ...
        // Add data points with percentage values
        for (int i = 0; i < 6; i++) {
        ...
        for (XYChart.Series<String, Number> series : barChart.getData()) {
            for (XYChart.Data<String, Number> data : series.getData()) {
                ...
                if (node != null) {
                    // Add hover effect and set thin bar width
        ...
        // Update AcInc and AcExp labels with the actual values
