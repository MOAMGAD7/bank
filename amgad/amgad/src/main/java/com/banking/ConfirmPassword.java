        ...
        if (hashedInputPassword.equals(storedHash)) {
            ...
            switch (paymentType) {
                case "Deposit":
                    ...
                    if (operationSuccess) {
                        System.out.println("✅ تمت عملية الإيداع بنجاح! المبلغ: " + paymentAmount + " للمستخدم: " + username);
                    }
                    break;
                ...
                case "Withdraw":
                    ...
                    if (operationSuccess) {
                        System.out.println("✅ تمت عملية السحب بنجاح! المبلغ: " + paymentAmount + " للمستخدم: " + username);
                    }
                    break;
            ...
            if (operationSuccess) {
                // العملية ناجحة، افتح شاشة النجاح
            ...
            // الباسورد غلط، ما يتمشيش العملية
